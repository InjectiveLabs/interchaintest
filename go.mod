...
require (
	...
	github.com/InjectiveLabs/sdk-go v1.58.2
...
replace (
	...
	// fix (same as in sdk-go go.mod):
	//go: github.com/bandprotocol/bandchain-packet@v0.0.0-00010101000000-000000000000: invalid version: unknown revision 000000000000
